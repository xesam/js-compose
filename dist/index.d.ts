...
export { NAME_SYM, decorate, around, wrap, default_hook, create_hook, };
export type { SrcFunction, FunctionDecoration, AroundDecoration, WrapDecoration, DecorationBuilder, ThisArg, ThisType, AttrName, LeafNode, TreeNode, AttrDecoration, NamedDecoration };
